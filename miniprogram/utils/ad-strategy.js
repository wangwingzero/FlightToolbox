...
var CONFIG = {
  ...
  INTERSTITIAL_AD_ENABLED: true,  // 已启用 - 2025年12月6日（低频策略）

  // 基础时间间隔（5分钟 = 300秒）- 用户体验优先
  BASE_TIME_INTERVAL: 5 * 60 * 1000,

  // 最少操作次数（页面切换次数）- 至少3次操作才触发
  MIN_ACTION_COUNT: 3,
