 ...
 * - 智能频率控制：
 *   ✓ 基础时间间隔：1分钟
 *   ✓ 操作次数阈值：至少1次操作（TabBar切换或卡片点击）
 *   ✓ 会话限制：每30分钟最多30次
 *   ✓ 每日上限：每天最多300次（已优化）
 *   ✓ 新用户保护：首次使用15分钟或10次操作后才展示
 *   ✓ 驾驶舱页面不展示（关键功能保护）
 *   ✓ 🆕 卡片点击触发：所有TabBar页面的卡片点击都会触发广告判断
 *   ✓ 🎁 激励视频奖励：观看后**1小时内**所有广告（横幅+插屏）全部隐藏
 *
 * 📋 授权的8个广告位ID：
