...
class StorageService {
    // 将静态属性改为静态方法或在类外定义常量
    static getUserProfileKey() { return 'user_profile'; }
    static getDraftPrefix() { return 'draft_'; }
    static getReportsKey() { return 'saved_reports'; }
    /**
     * 用户预设信息相关
     */
    ...
    static saveDraft(eventTypeId, formData) {
        try {
