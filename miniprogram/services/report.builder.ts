import { EventType, ReportData } from './event.types';
...
export class ReportBuilder {
   ...
   * 根据事件类型和表单数据生成报告文本
   */
  static generateReport(eventType: EventType, formData: Record<string, any>): string {
   ...
   * 创建完整的报告数据对象
   */
  static createReportData(eventType: EventType, formData: Record<string, any>): ReportData {
   ...
   * 验证表单数据完整性
   */
  static validateFormData(eventType: EventType, formData: Record<string, any>): { isValid: boolean; missingFields: string[] } {
