...
function AudioPreloadGuide() {
  ...
  this.preloadPageMapping = {
    'japan': {
      ...
      regionName: '日本成田机场',
      flag: '🇯🇵',
      preloadPage: 'packageNav/airline-recordings/index',
    ...
    'philippines': {
      ...
      regionName: '菲律宾马尼拉机场',
      flag: '🇵🇭',
      preloadPage: 'packageNav/recording-categories/index',
    ...
    'korea': {
      ...
      regionName: '韩国仁川机场',
      flag: '🇰🇷',
      preloadPage: 'packageNav/audio-player/index',
    ...
    'thailand': {
      ...
      regionName: '泰国曼谷机场',
      flag: '🇹🇭',
      preloadPage: 'packageNav/recording-clips/index',
