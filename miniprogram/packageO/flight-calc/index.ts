...
Page({
  ...
  selectModule(event: any) {
    ...
    const modulePageMap: { [key: string]: string } = {
      'descent': '/packageO/flight-calc-modules/descent/index',
      'crosswind': '/packageO/flight-calc-modules/crosswind/index',
      'turn': '/packageO/flight-calc-modules/turn/index',
      'glideslope': '/packageO/flight-calc-modules/glideslope/index',
      'detour': '/packageO/flight-calc-modules/detour/index'
    };
  ...
  performTurnRadiusCalculation() {
    ...
    this.setData({
      turnRadiusMeters: this.formatNumber(radiusNauticalMiles), // 使用海里替代米显示
