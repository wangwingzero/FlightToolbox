...
WeChat Mini Program designed for airline pilots. Provides offline-first flight tools, reference data, and utilities.

## Core Value Proposition
- **Offline-First**: All features must work in airplane mode (pilots cannot use network during flight)
- **Professional Tools**: Flight calculators, reference data, communication aids
...
- Flight students and instructors
